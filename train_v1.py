...
TRAIN_FILES = provider.getDataFiles( \
    os.path.join(BASE_DIR, 'data/bu3d_frontal_600/train_files.txt'))
TEST_FILES = provider.getDataFiles(\
    os.path.join(BASE_DIR, 'data/bu3d_frontal_600/test_files.txt'))
...
def train_one_epoch(sess, ops, train_writer):
    ...
    for fn in range(len(TRAIN_FILES)):
        ...
        #current_data = (current_data)/(current_data.max() - current_data.min())
